 ...
 */
export async function translateText(textToTranslate, targetLanguage = 'Vietnamese') {
...
// Example usage:
const paragraph = "The quick brown fox jumps over the lazy dog. This is a classic example sentence used for testing.";
