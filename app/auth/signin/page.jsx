    ...
    <div className="bg-gray-100 flex items-center justify-center min-h-screen p-4 sm:p-6 md:p-8">
      ...
      <div className="bg-white rounded-3xl shadow-xl overflow-hidden w-full max-w-sm sm:max-w-md lg:max-w-lg p-8 sm:p-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <button onClick={handleGoogleSignIn} className="cursor-pointer hover:shadow-sm w-full py-2.5 px-4 rounded-xl border border-gray-300 flex items-center justify-center space-x-2 hover:bg-gray-50 transition">
            <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
              <path d="M12.24 10.285V14.4H17.476C17.214 15.939 16.34 17.159 15.214 17.915L18.497 20.378C19.982 19.006 20.84 17.069 21.328 14.898H12.24V10.285Z" fill="#4285F4" />
              <path d="M12.24 21.614C9.537 21.614 7.23 20.73 5.41 19.349L8.72 16.892C9.547 17.456 10.638 17.8 12.24 17.8C14.717 17.8 16.438 16.38 17.24 14.898L20.523 17.36C19.337 19.362 16.83 21.614 12.24 21.614Z" fill="#34A853" />
              <path d="M5.41 19.349L2.127 16.892C1.192 15.632 0.5 14.07 0.5 12.24C0.5 10.41 1.192 8.848 2.127 7.588L5.41 5.13C4.547 6.138 4.0 7.575 4.0 9.24C4.0 10.905 4.547 12.342 5.41 13.35L8.72 15.807C7.23 16.994 5.926 18.067 5.41 19.349Z" fill="#FBBC05" />
              <path d="M21.328 14.898H24.5V10.285H21.328C20.84 8.114 19.982 6.177 18.497 4.805L15.214 7.268C16.34 8.024 17.214 9.244 17.476 10.776H12.24V14.898H21.328Z" fill="#EA4335" />
            </svg>
